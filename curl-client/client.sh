...
curl http://10.11.1.5/api/beers --data "name=beer1&type=type1&alcoholic_degree=1" >> $RESULT
curl http://10.11.1.5/api/beers --data "name=beer2&type=type2&alcoholic_degree=2" >> $RESULT
curl http://10.11.1.5/api/beers --data "name=beer2&type=type2&alcoholic_degree=2" >> $RESULT #creazione fallita, birra già esistente
echo -e '\n \n' >> $RESULT
...
curl http://10.11.1.5/api/beers >> $RESULT
echo -e '\n \n' >> $RESULT
...
curl http://10.11.1.5/api/beers/`echo ${ar[0]}` >> $RESULT
echo -e '\n \n' >> $RESULT
...
curl http://10.11.1.5/api/beers/`echo ${ar[0]}` --data "name=mod&type=mod&alcoholic_degree=100&_method=PUT" >> $RESULT
echo -e '\n \n' >> $RESULT
...
curl http://10.11.1.5/api/beers/`echo ${ar[0]}` --data "name=mod&type=mod&alcoholic_degree=100&_method=DELETE" >> $RESULT
echo -e '\n \n' >> $RESULT
